...
#+end_src
* Boon mode
Another modal editing framework for emacs

** install boon
#+begin_src emacs-lisp :tangle "my-modules/my-boon.el" :mkdirp yes
  (straight-use-package 'boon)
  ;; TODO: implement boon-hd-gold
  ;; (require 'boon-qwerty)
#+end_src

** Require custom "hands down gold" keymap
