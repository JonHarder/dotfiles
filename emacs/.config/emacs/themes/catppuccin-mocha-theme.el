;;; catppuccin-mocha-theme --- a port of the catppuccin mocha theme using modus infrastructure  -*- lexical-binding: t; -*-
;;; Commentary:
...
(modus-themes-theme
 'catppuccin-mocha
 'modus-themes
 "A port of the catppuccin mocha theme built using modus themes."
 'dark
